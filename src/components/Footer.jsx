    ...
    <footer className="bg-white pt-24 pb-12 border-t border-slate-100 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="lg:col-span-1">
            <div className="grid grid-cols-1 gap-8">
              ...
              <div>
                ...
                <ul className="space-y-4 font-bold">
                  <li><a href="#" className="text-slate-500 hover:text-accent-blue transition-colors text-base block">Privacy Policy</a></li>
                  <li><a href="#" className="text-slate-500 hover:text-accent-blue transition-colors text-base block">Terms of Service</a></li>
                  <li><a href="#" className="text-slate-500 hover:text-accent-blue transition-colors text-base block">Cookie Policy</a></li>
                </ul>
              </div>
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-center lg:justify-start gap-3">
                    ...
                    <a href="tel:+919527537131" className="text-slate-600 hover:text-accent-blue transition-colors">
                      +91 95275 37131
                    </a>
                  </div>
                  <div className="flex items-center justify-center lg:justify-start gap-3">
                    <Mail className="w-5 h-5 text-accent-blue flex-shrink-0" />
                    <a href="mailto:info@codeluxe.com" className="text-slate-600 hover:text-accent-blue transition-colors">
                      info@codeluxe.com
                    </a>
                  </div>
        ...
        <div className="pt-10 border-t border-slate-100 flex flex-col md:flex-row justify-between items-center text-center md:text-left gap-6">
          ...
          <div className="flex flex-col items-center text-xs font-black uppercase tracking-[0.2em] whitespace-nowrap">
            <span className="text-slate-400">Designed by</span>
            <span className="text-accent-blue">Sandhya Softtech Pvt Ltd , Ambajogai</span>
          </div>
        </div>
